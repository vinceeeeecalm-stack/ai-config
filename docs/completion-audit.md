...
| Public Netlify UI and API | Production Netlify deploy `6a376e62cee1295858613721` is ready. Static `relay-chat.js` serves version `2026.06.21.8`, and `/api/relay/status` returns `ok: true`. The old `mobile-relay` function name is now compatibility-wrapped to the current implementation. | Complete |
...
tunnel URL: https://99643dcd781372.lhr.life/relay-chat.html
...
- Current public tunnel UI: `https://99643dcd781372.lhr.life/relay-chat.html`
